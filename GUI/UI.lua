...
FOVSection:AddSlider({ Name = "Radius", Value = FOVSettings.Amount, Min = 10, Max = 300, Decimals = 0, Callback = function(v) FOVSettings.Amount = v end }).Default = FOVSettings.Amount
